...
<head>
    ...
    <title>VisitLog | Old and New Visitor</title>
...
<body class="hold-transition sidebar-mini">
        ...
        <div class="content-wrapper" style="height:auto">
            ...
            <section class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1>Old and New Visitor</h1>
                        </div>
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="users.php">Dashboard</a></li>
                                <li class="breadcrumb-item active">Old and New Visitor</li>
                            </ol>
                        </div>
                    </div>
                </div><!-- /.container-fluid -->
    ...
    <script src="assets/js/rpt-old-new.js"></script>
