...
<body class="hold-transition sidebar-mini">
                            ...
                            <div class="card card-primary card-outline">
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <!-- CONTENT -->
                                            <table id="visitHisTable" class="table table-bordered table-hover">
                                                <thead>
                                                    <tr>
                                                        <th>Name</th>
                                                        <th>Address</th>
    ...
    <!-- Custom -->
    <script src="assets/js/visithistory.js"></script>
    <script>
        const dept = '<?php echo $dept->get_name($_SESSION['dept'])?>';
    </script>
</body>
